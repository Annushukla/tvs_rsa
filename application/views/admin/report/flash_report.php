...
<div class="wrapper">
  ...
  <section class="content-header report-blocks">
	    <h1 style="color:blue">Flash Report</h1>
	    <br>
      <div class="container">
        <form class="form-horizontal" name="submitdate" method="post" action="<?php echo base_url('admin/flash_report')?>">  
            <div class="row form-group">
              <div class="col-md-6">
               ...
               <div class="col-md-5">
                 <a class="btn btn-primary pull-right" onclick="tableToExcel('flash_report', 'Flash Report','flash_report.xls')" >Export to Excel</a>
              </div>              
            </div>
        </form>
      </div>
      ...
      <div class="col-md-12">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="flash_report">
                  ...
                  <?php $i=1;
                        ...
                        foreach($paicpolicycounts as $value) {
                          extract($value);
