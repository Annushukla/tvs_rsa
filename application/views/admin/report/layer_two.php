  ...
  <div class="content-wrapper">
    ...
    <div class="container">
      <div class="row" style="border:5px solid #087cc6; padding: 10px 0; margin-bottom: 20px; ">
        <div class="col-md-12">
         <table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl" style="margin: 0;">
            <tr>
                <td class="headtitle">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl">
                    <thead class="thead-light">
                        
                        <tr>
                            <th rowspan="2" colspan="3" class="text-center">MAIN HEAD</th>
                            <th colspan="17" class="text-align">Sale Price</th>
                        </tr>
                        <tr>
                                <th colspan="4" class="text-align">TD</th>
                                <th colspan="4" class="text-align">MTD</th>
                                <th colspan="5" class="text-align">YTD</th>
                        </tr>
                        <tr>
                                <th>Sr. No.</th>
                                <th>PARTICULAR</th>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl" style="margin: 0;">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl">
                    <thead class="thead-light">
                        ...
                        <tr>
                                ...
                                <th colspan="6" class="text-align">YTD</th>
                        </tr>
                        <tr>
                                <th>Sr. No.</th>
                                <th>PARTICULAR</th>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl">
                    <thead class="thead-light">
                        <tr>
                            <th rowspan="2" colspan="3" class="text-center">MAIN HEAD</th>
                            <th colspan="19" class="text-align">PURCHASE COST RSA</th>
                        </tr>
                        <tr>
                            <th colspan="5" class="text-align">TD</th>
                            <th colspan="5" class="text-align">MTD</th>
           ...
           <table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl" style="margin: 0;">
            <tr>
                <td class="headtitle">
                     <div class="text-center">
                        <h2>PURCHASE COST DEALER COMMISION</h2>
                      </div>
                </td>
            </tr>
        </table> 
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl">
                    <thead class="thead-light">
                        <tr>
                            <th rowspan="2" colspan="3" class="text-center">MAIN HEAD</th>
                            <th colspan="19" class="text-align">PURCHASE COST DEALER COMMISION</th>
                        </tr>
                        <tr>
                                <th colspan="5" class="text-align">TD</th>
                                <th colspan="5" class="text-align">MTD</th>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl">
            ...
            <tr>
                <td class="headtitle">
                     <div class="text-center">
                        <h2>ICPL/GIIB MARGIN AND GST</h2>
                      </div>
                </td>
            </tr>
        </table>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-sm table-bordered table-striped bg-white colored_tbl">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th  colspan="3" class="text-center">MAIN HEAD</th>
