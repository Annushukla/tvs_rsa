              ...
              <tbody>
               ...
               <!--    <td style="text-align:center;padding: 0px 6px 0px 14px;">
                  ...
                  <td style="text-align:center;">
                    ...
                    <p>Click Here to Download Mapped Dealer-IC  &nbsp;&nbsp;<i class="fa fa-arrow-right"></i></p>
...
function last_policy_date_csv()
  {
    ...
    $.ajax({
    url : base_url+"Report/DownloadMappedDealer/"+datas,
    type: "POST",
    success: function(data){
      if(data!=""){
        alert('Feed-File Downloaded');
      }
      window.location=base_url+"Report/DownloadMappedDealer/"+datas;
    }
  });
