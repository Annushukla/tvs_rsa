            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="example-col">
                        <table class="table table-bordered table-striped w-full" id="mytvs_policy_tbl">
                            <thead>
                            <th>Sr.no</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#mytvs_policy_tbl').DataTable({
            ...
            "ajax": {
                'url': base_url + 'admin/mytvs_policies_ajax',
                "type": "POST",
                "dataType": "json",
        ...
        $('#filter_by_date').on('click', function () {
            ...
            table1 = $('#mytvs_policy_tbl').DataTable({
                'paging': true,
                'destroy': true,
