...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
               RR310 New Bharti Assist Policies(Limit Assist)
            </h1>
            <br><br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="example-col">
                        <table class="table table-bordered table-striped w-full" id="limitless_assist_bharti">
                            <thead>
                            <th>Sr.no</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#limitless_assist_bharti').DataTable({
            ...
            "ajax": {
                'url': base_url + 'admin/limitless_assist_RR310_Bharti_ajax',
                "type": "POST",
                "dataType": "json",
        ...
        $('#filter_by_date').on('click', function () {
            ...
            table1 = $('#limitless_assist_bharti').DataTable({
                'paging': true,
                'destroy': true,
