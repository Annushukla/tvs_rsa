<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Download Oriental Cancelled Feed-File
      </h1>
              ...
              <tbody>
                <tr>
                  <td style="text-align:center;padding: 0px 6px 0px 14px;"><input type="date"   name="from_date"  id="from_date" class="form-control form-control-sm" style="height: 42px;">
                    <input type="hidden" name="ic_id" id="ic_id" value="<?= $ic_id ?>">
      ...
      var ic_id = $('#ic_id').val();
		  ...
		  if(er_status==false){
		      if(from_date <= to_date){
		          $.ajax({
		              url : base_url+'Report/download_oriental_cancelled_feedfile',
		              type : 'POST',
		              dataType : 'JSON',
		              data : {from_date : from_date , to_date: to_date , ic_id:ic_id},
