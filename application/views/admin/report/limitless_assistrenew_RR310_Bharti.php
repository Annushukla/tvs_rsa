...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
               RR310  Renew Bharti Assist Policies
            </h1>
            <br><br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="example-col">
                        <table class="table table-bordered table-striped w-full" id="limitless_assistrenew_bharti">
                            <thead>
                            <th>Sr.no</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#limitless_assistrenew_bharti').DataTable({
            ...
            "ajax": {
                'url': base_url + 'admin/limitless_assistrenew_RR310_Bharti_ajax',
                "type": "POST",
                "dataType": "json",
        ...
        $('#filter_by_date').on('click', function () {
            ...
            table1 = $('#limitless_assistrenew_bharti').DataTable({
                'paging': true,
                'destroy': true,
