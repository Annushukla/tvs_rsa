            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="example-col">
                        <table class="table table-bordered table-striped w-full" id="viewopenrsapolicy_datatable">
                            <thead>
                            <th>Sr.no</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#viewopenrsapolicy_datatable').DataTable({
            ...
            "ajax": {
                'url': base_url + 'admin/view_openrsa_policy_ajax',
                "type": "POST",
                "dataType": "json",
        ...
        $('#filter_by_date').on('click', function () {
            ...
            table1 = $('#viewopenrsapolicy_datatable').DataTable({
                'paging': true,
                'destroy': true,
