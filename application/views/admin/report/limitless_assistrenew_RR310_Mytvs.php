            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="example-col">
                        <table class="table table-bordered table-striped w-full" id="limitless_assistrenew_mytvs">
                            <thead>
                            <th>Sr.no</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#limitless_assistrenew_mytvs').DataTable({
            ...
            "ajax": {
                'url': base_url + 'admin/limitless_assistrenew_RR310_Mytvs_ajax',
                "type": "POST",
                "dataType": "json",
        ...
        $('#filter_by_date').on('click', function () {
            ...
            table1 = $('#limitless_assistrenew_mytvs').DataTable({
                'paging': true,
                'destroy': true,
