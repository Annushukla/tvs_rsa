<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Kotak openrsa-Feedfile Download</h1>
...
function download_csv()
  ...
  if(status==true){
        if(from_date <= to_date){
              $.ajax({
              url : base_url+"Report/download_kotakopenrsa_feedfile/"+datas,
              type: "POST",
              success: function(data){
                if(data!=""){
                  alert('Feed-File Downloaded');
                }
             window.location=base_url+"Report/download_kotakopenrsa_feedfile/"+datas;
              }
            });
        }else{
