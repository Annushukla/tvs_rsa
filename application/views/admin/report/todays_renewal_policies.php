            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="example-col">
                        <table class="table table-bordered table-striped w-full" id="todays_renewd_policy_tbl">
                            <thead>
                            <th>Sr.no</th>
...
$(document).ready(function () {
        table = $('#todays_renewd_policy_tbl').DataTable({
            ...
            "ajax": {
                'url': base_url + 'Report/todays_renewd_policy_ajax',
                "type": "POST",
                "dataType": "json",
        ...
        $('#filter_by_date').on('click', function () {
            ...
            table1 = $('#todays_renewd_policy_tbl').DataTable({
                'paging': true,
                'destroy': true,
