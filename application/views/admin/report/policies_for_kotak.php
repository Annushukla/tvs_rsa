            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="example-col">
                        <table class="table table-bordered table-striped w-full" id="kotak_policy_datatable">
                            <thead>
                            <th>Sr.no</th>
                            <th>Policy No</th>
                            <th>Sum Insured</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#kotak_policy_datatable').DataTable({
            ...
            "ajax": {
                'url': base_url+'Report/kotak_policy_ajax',
                "type": "POST",
                "dataType": "json",
        ...
        $('#filter_by_date').on('click', function () {
            ...
            table1 = $('#kotak_policy_datatable').DataTable({
                'paging': true,
                'destroy': true,
