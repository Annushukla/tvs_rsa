        ...
        <td>
          <table cellpadding="0" border="0" cellspacing="0">
            <tr>
              ...
              <td width="30%" class="textright"><img src="images/hdfc-ergo-logo.png" height="70"></td>                
            </tr>
          </table>
          <table cellpadding="0" border="0" cellspacing="0">
            <tr>
              <td width="32%" class="font-8"><b>Master Policy No.</b> <br><b>Certificate Number:</b></td>
    ...
    <tr>
      <td>
        <table cellpadding="2" border="0" cellspacing="0" class="boxtable">
          <tr>
            <td width="40%"><b>Proposer Name:</b> </td> 
        ...
        <table cellpadding="2" border="0" cellspacing="0" class="boxtable">
            <tr>
              ...
              <td width="60%"><b>Permanent Address:</b> </td>              
            </tr>
        </table>
        <table cellpadding="0" border="0" cellspacing="0">
            <tr>
        ...
        <table cellpadding="2" border="0" cellspacing="0" class="boxtable">
          <tr>
            ...
            <td width="25%">From Date & Time: DD/MM/YY 00.00 hrs </td>
            <td width="25%">To Date & Time: DD/MM/YY Midnight </td>
            <td width="30%"><b>Policy Issuance Date:</b> DD/MM/YYYY</td>
          </tr>       
        </table>
        <table cellpadding="0" border="0" cellspacing="0">
            <tr>
        ...
        <table cellpadding="2" border="0" cellspacing="0" class="boxtable">
          ...
          <tr>
            ...
            <td class="textcenter">500,000</td>
          </tr>
          <tr>
     ...
     <tr>
      <td>  
        <table cellpadding="0" border="0" cellspacing="0">  
          ...
          <tr>
            <td><img src="images/sign-img.jpg" height="40"></td>  
          </tr>
          <tr>
