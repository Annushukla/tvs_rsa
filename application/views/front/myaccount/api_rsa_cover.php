                            ...
                            <form class="form-horizontal" id="vehicle_details_form" action="#">
                                <div id="custom-search-input">
                                    <div class="input-group col-md-12 border-light">
                                        <input type="text" class="search-query searchbox" name="vehicle_detail" id="vehicle_detail" placeholder="Enter customer’s Vehicle’s Engine No." value="<?php echo $engine_no ?>" style="color:black;" readonly>
                    ...
                    <div id="cust_info_panel">
                        <div id="cust_info" class="custom-ewnow-form">
                            <div class="col-md-12 form-blue">
                                ...
                                <form method="post" action="<?php echo base_url('submit_renewal_policy_data'); ?>" autocomplete="off" class="form-horizontal" role="form" id="pending_policy_form">
                                    <div class=" ">
                                     ...
                                     <div class="col-md-12">
                                                <div class="form-group" id="vehicle_type_div">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input type="radio" name="vehicle_type" id="vehicle_type" class="vehicle_type" value="OLD" checked> Old</label>
                                                    </div>
                                                </div>
                                     </div>
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                <div class="form-group" id="manufacturer_cont">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="manufacturer" id="manufacturer" name="manufacturer" class="form-control cust_info_field" disabled="<?php echo $disabled; ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group" id="model_cont">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="pending_model_id" id="pending_model_id" class="form-control cust_info_field" data-message = "Model" <?php echo $disabled ;?> >


                                                        </select>
                                                        <span id="error-pending_model_id" style="color: red"><?php echo $this->session->flashdata('er_model_id'); ?></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="text" id="dob_renew" name="dob" placeholder="DOB" class="form-control cust_info_field"  value="" readonly>
                                                        </div>
                                                        <span id="error-dob_renew" style="color: red">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="pending_pin" class="col-sm-3 control-label">Pin</label>
                                                    <div class="col-sm-9">
                                                        <input maxlength="6" size="6" type="text" id="pending_pin" name="pending_pin" placeholder="ENTER PIN" class="form-control cust_info_field" value="<?php echo $pincode; ?>" autofocus>
                                                        <span id="error-pending_pin" style="color: red"><?php echo $this->session->flashdata('er_pending_pin'); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              ...
                                                              <td>Current</td>
                                                               ...
                                                               <td><input type="radio" name="plan" id="<?php echo $plan_code;?>" value="<?php echo $id;?>" data-plan="<?php echo $plan_amount;?>" checked></td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
                                                  </div>
                            ...
                            <div class="col-md-12 text-right padng-B p-0" style="margin: 20px 0;">
                                <div class="col-md-12">
                                    <input type="hidden" id="hid_policy_id" value="<?= $policy_id ?>" name="hid_policy_id">
                                    <input type="hidden" id="hid_user_id" value="98765" name="hid_user_id">
                                    <input type="hidden" id="hid_ic_id" name="hid_ic_id" value="<?php echo $ic_id;?>">
                                    <input type="hidden" id="is_renewed" name="is_renewed" value="<?php echo $is_renewed;?>">
                                    <!-- <input type="hidden" id="registration_date" value="" name="registration_date"> -->
                                    <button type="button" id="generate_pending_policy" class="btn btn-primary button_purple">Generate Policy</button>
                                </div>
                            </div>
                        </div>
                        </form>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="  border-radius: 0px;">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary  button_purple" id="confirm_apirsa_submit">Confirm</button>
