...
<main class="section--lightGray main-ewnow" style="  font-family: 'Roboto';">
    <header class="custom-pacoverheader text-center">
        ...
        <p>Renewal RoadSide Assistance</p>
                            ...
                            <form class="form-horizontal" id="vehicle_details_form" action="#">
                                <div id="custom-search-input">
                                    <div class="input-group col-md-12 border-light">
                                        <input type="text" class="search-query searchbox" name="search_engine_no" id="search_engine_no" placeholder="Enter customer’s Vehicle’s Engine No." value="<?php echo $engine_no ?>" style="color:black;">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/tvsrsa_renewal.js"></script>
