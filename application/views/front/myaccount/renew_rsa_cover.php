...
<?php
    $dob = !empty($dob)?date('m/d/Y',strtotime($dob)):'';
                                     ...
                                     <div class="col-md-12">
                                                <div class="form-group" id="vehicle_type_div">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input type="radio" name="vehicle_type" id="vehicle_type" class="vehicle_type" value="NEW"> New</label>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label for="vehicle_type" class="col-sm-6 control-label">
                                                        <input type="radio" name="vehicle_type" id="vehicle_type" class="vehicle_type" value="OLD" checked="checked"> Old</label>
                                                    </div>
                                                </div>
                                     </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group" id="model_cont">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="model_id" id="model_id" class="form-control cust_info_field" data-message = "Model">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="first_name" class="col-sm-3 control-label">Middel Name
                                                    </label>
                                                    <div class="col-sm-9">
                                                        <input type="text" id="middel_name"  value="<?php echo $mname; ?>" name="middel_name" placeholder="MIDDEL NAME" class="form-control cust_info_field" autofocus style="text-transform:uppercase">
                                                        <span id="error-middel_name" style="color: red"><?php echo $this->session->flashdata('er_middel_name'); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="mobile_no" class="col-sm-3 control-label">DOB
                                                        <span style="color:red" >*</span></label>
                        <div class="col-sm-9">
                            <input type="text" id="dob" name="dob" placeholder="DOB" class="form-control cust_info_field"  value="<?=$dob;?>" readonly>
                        ...
                        <?php echo $this->session->flashdata('er_dob'); ?></span>
                                    ...
                                    <div class="row" id="appointee_div" style="display: none;">
                                     ...
                                     <div class="row plandetails-wrap">
                                        ...
                                        <div class="col-md-12 text-left plan-details cf p-0">
                                             <?php
                                                ...
                                                <div class="plan cf col-md-4">
                                                    <label>
                                                    <input type="radio" name="plan_type" id="plan_type" value="<?php echo $plan_type['id']?>" data-plan="" <?php echo $checked;?>> &nbsp;&nbsp; <?php echo $plan_type['plan_type'];?>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-12 text-left p-0 " id="plan_details">
                                        </div>
                                        <p id="error-plan_type" style="color: red"></p>
                                    </div>
                            ...
                            <div class="col-md-12 text-right padng-B p-0" style="margin: 20px 0;">
                                <div class="col-md-12">
                                    <input type="hidden" name="page_name" id="page_name" value="renewal">
                                    ...
                                    <input type="hidden" id="dms_ic_id" value="<?=$policy_data['ic_id']?>" name="dms_ic_id">
                                    <input type="hidden" id="registration_date" value="" name="registration_date">
                                    <button type="button" id="pa_cover_generate_button" class="btn btn-primary button_purple" disabled="disabled">Generate Policy</button>
                                </div>
                            </div>
                        </div>
                        </form>
