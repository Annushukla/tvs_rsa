                ...
                <div class="col-md-12 white-bg" style="height:  auto;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="hidden" name="page_name" value="workshop" id="page_name" class="workshop">
                                ...
                                <div id="custom-search-input">
                                    <div class="input-group col-md-12 border-light">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-danger" type="button" id="workshop_search_button">
                    ...
                    <div id="cust_info_panel">
                        <div id="cust_info" class="custom-ewnow-form">
                            <div class="col-md-12 form-blue">
                                ...
                                <form method="post" action="<?php echo base_url('generate_rsa_workshop_policy'); ?>" autocomplete="off" class="form-horizontal" role="form" id="rsa_workshop_form">
                                    <div class=" ">
                                        ...
                                        <div class="col-md-12 text-left plan-details cf p-0">
                                             <?php
                                                ...
                                                <div class="plan cf col-md-4">
                                                    <label>
                                                    <input type="radio" name="plan_type_workshop" id="plan_type_workshop" value="<?php echo $plan_type['id']?>" data-plan="" <?php echo $checked;?> checked> &nbsp;&nbsp; <?php echo $plan_type['plan_type'];?>
                                                    </label>
                                                </div>
                            ...
                            <div class="col-md-12 text-right padng-B p-0" style="margin: 20px 0;">
                                <div class="col-md-12">
                                    ...
                                    <button type="button" id="generate_workshop_button" class="btn btn-primary button_purple" disabled="disabled">Generate Policy</button>
                                </div>
                            </div>
                        </div>
                        </form>
...
<div class="modal fade" id="confirm_worksop_modal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="  border-radius: 0px;">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary  button_purple" id="confirm_workshop_submit">Confirm</button>
