                                     ...
                                     <div class="col-md-12">
                                                <div class="form-group" id="vehicle_type_div">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input type="radio" name="vehicle_type" id="vehicle_type" class="vehicle_type" value="NEW" <?php echo ($vehicle_type == 'New' || empty($vehicle_type))?'checked="checked"':''?> > New</label>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label for="vehicle_type" class="col-sm-6 control-label">
                                                        <input type="radio" name="vehicle_type" id="vehicle_type" class="vehicle_type" value="OLD" <?php echo ($vehicle_type == 'OLD')?'checked="checked"':''?>> Old</label>
                                                    </div>
                                                </div>
                                     </div>
                                        <div class="col-md-12">
