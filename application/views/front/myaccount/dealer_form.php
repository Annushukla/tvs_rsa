                        ...
                        <div id="cust_info" class="custom-ewnow-form">
                            <div class="col-md-12 form-blue">
                                <form method="post" id='submit_dealer_details' action="<?php echo base_url('submit_dealer_details'); ?>" autocomplete="off" class="form-horizontal" role="form" id="vehcile_data_formm">
                                    <div class=" ">
                                        <div class="col-md-12 text-left nopadding" style="position: relative;"><h5>VENDOR / DEALER DETAILS</h5>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="dealer_full_name" class="col-sm-3 control-label">Dealer Full name
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                       <select id="company_type" name="company_type" class="form-control cust_info_field company_type" data-message="Company Type">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                       <select id="account_type" name="account_type" class="form-control cust_info_field account_type" data-message="Account Type" required>
                                                           <option value="">Select Option</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Insurance Company<span style="color:red" >*</span></label>
                                            <div class="col-sm-9">
                                               <select id="pa_ic_id" name="pa_ic_id" class="form-control cust_info_field pa_ic_id" data-message="PA IC" required>
                                                   <option value="">Select Option</option>
                                                   <?php if(!empty($pa_ics)){
                                                ...
                                                <span id="error-pa_ic_id" style="color: red"><?php echo $this->session->flashdata('pa_ic_id'); ?></span>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
