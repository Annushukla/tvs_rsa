    ...
    <div class="container adminpage-wrap">
        <div class="col-md-3">
            <div class="adminpage-sidebar">
                <ul>
                    ...
                    <li class="active"><a href="<?php echo base_url('renewal_policy');?>"> Policy Renewal </a></li>
        ...
        <div class="col-md-9">
            <div class="adminpage-content">  
                ...
                <h3 class="adminpage-pagehead">Renewal Policies</h3>
                <div class="adminpage-texter">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group form-inline text-right">
                            <label>Select Days</label>
                            <select name="days" id="days" class="form-control cust_info_field" data-message="days">
                                <option value="">Select Days</option>
                                <?php foreach (range(1, 60) as $number) {?>
                                    <option value="<?php echo $number;?>"<?php echo ($number == 10)?'selected="selected"':'';?>><?=$number?></option>
                                <?php }?>
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive" style="border-top: 1px solid #ddd; padding-top: 15px;">
                                <table class="table table-striped custom-table datatable" id="renewal_policy_datatable" border="0">
                                    <thead>
                                    	<tr>
	                                        <th>Sr.No.</th>
	                                        <th>Policy No</th>
