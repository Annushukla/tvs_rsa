...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- select2  -->
        <link rel="stylesheet" href="<?php echo base_url();?>public/front_css_js/css/selectize.css" />
        <!-- common -->
...
<link rel="stylesheet" type="text/css"  href="<?php echo base_url();?>public/front_css_js/css/magnific-popup.css">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav nav-black nav-border-bottom " role="navigation">
            <div class="container width-100">
                ...
                <img al<!-- t="" src="<?php echo base_url();?>public/front_css_js/images/giib/logo.jpg" class="logo-muthoot"></a>
                    </div>
                    <!-- end logo -->
                        ...
                        <div class="navbar-collapse collapse">
                             <ul id="accordion" class="nav navbar-nav navbar-right panel-group">
                                ...
                                <li class="dropdown panel simple-dropdown">
                                    <a href="<?php base_url();?>myaccount" class="" data-toggle="" >My Account
