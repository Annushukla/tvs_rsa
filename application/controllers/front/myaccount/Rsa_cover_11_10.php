                                    ...
                                    switch ($master_policy_details['ic_id']) {
                                        ...
                                        $this->data['inserted_id'] = $inserted_id;
                                           ...
                                           // header('location: download_il_lite_pdf/' . $inserted_id . '');
                                            break;
                                        case 7:
                                        $this->data['ic_pdf'] = 'download_hdfc_policy';
                                        $this->data['inserted_id'] = $inserted_id;
                                            $this->load->dashboardTemplate('front/myaccount/success', $this->data);
                                           // header('location: download_il_lite_pdf/' . $inserted_id . '');
                                            break;
          ...
          <table cellpadding="1" border="0" cellspacing="0">
            <tr>
              ...
              <td width="35%">
                <table cellpadding="1" border="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><img src="assets/images/bharti-assist-global.jpg" height="40"></td>
                  </tr>
                  <tr>
...
$pdf->Output('HDFC-ERGO-GPA-Policy.pdf', 'S');
...
function LibertyGeneral($id){
  ...
  if(!empty($created_date)){
        $exploded_date = explode(" ", $rsa_policy_data['sold_policy_effective_date']);
          ...
          <td>
            <table cellpadding="2" border="0" cellspacing="0" class="boxtable">
              ...
              <tr>
                ...
                <td colspan="2"><table cellpadding="1" border="0" cellspacing="0">
                    <tr>
                      <td colspan="2" class="textcenter line-height-16"><b>411241120000000406001500001021</b></td>
                    </tr>
                    <tr>
                      <td width="45%"><b>Name of Master Policy Holder: </b></td>
                      <td width="55%">M/S Reliance Retail</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>From {$sold_policy_effective_date}  To {$sold_policy_end_date}</td>
                    </tr>
                  </table>
                </td>
              </tr> 
            ...
            <table cellpadding="2" border="0" cellspacing="0" class="boxtable font-6-5">
              <tr>
                <td>1. 1. Accidental Death (AD) -Covers Death due to Accident 2. Permanent Total Disability (PTD)-Covers Permanent Total Disability due to Accident, which totally disables the Insured from attending to any occupation/job/business or normal duties for a continuous period of 12 months 3. Accidental Hospital Daily Cash-Daily allowance of Rs. 500 for a max of 30 days subject to minimum of 48 hours of hospitalization 4. Permanent Partial Disability (PPD)-Covers Permanent Partial Disability of the Insured relating to any part of the limbs or organs of the body. 5. Cost of Transporting Mortal Remains -Reimbursement of expenses upto Rs. 10000 incurred for transportation of mortal remains to the city of residence where the final funeral ceremony is to be performed. 6. Child Education Support-Provides for payment towards dependent child/children’s tuition fees in case of accidental death or Permanent Total Disability for Rs. 5000 per child for max of 2 dependent children 7. Double Indemnity-Sum Insured equivalent to the Capital Sum Insured provided if death or PTD occurs following an accidental injury whilst traveling in public carriers like Bus, ferry, hovercraft, ship, taxi, train, tram, underground train, commercial helicopter or aircraft. 8. Any form of Nuclear, Chemical and biological Terrorism is excluded. 9. Scope of Cover - 24 hrs, Worldwide. However, we shall not be deemed to provide cover and shall not be liable to pay any claim or provide any benefit hereunder to the extent that the provision of such cover, payment of such claim or
                  provision of such benefit would expose us to any sanction, prohibition or restriction under United Nations resolutions or the trade or economic sanctions, laws or regulations of the European Union, United Kingdom or United States of America.</td>
              </tr>
            </table>
            <table cellpadding="1" border="0" cellspacing="0">
              <tr>
         ...
         <tr>
          <td>        
            <table cellpadding="0" border="0" cellspacing="0">
              <tr>
                <td width="50%"><table cellpadding="0" border="0" cellspacing="0">
                    ...
                    <tr>
                      <td>UIN:</td>
                      <td>IRDA/NL-HLT/LVGI/P-P/V.II/09/14-15</td>
                    </tr>
                  </table>
                </td>
            ...
            <table cellpadding="0" border="0" cellspacing="0"> 
              ...
              <tr>
                <td><b>For Policy related assistance please feel free to write to us on care@libertyinsurance.in OR call us on our Toll Free number 1800 266 5844 (between 8:00 am to 8:00 pm, 7 days of the week) our representatives will be glad to help you</b></td>
              </tr>
            </table>
          </td>
        </tr>
...
// echo $created_date[0];die('abc');
            ...
            switch ($main->ic_id) {
                case 2:
                    $file_list = '<a href="' . base_url() . 'download_kotak_lite_pdf/' . $main->policy_id . '/'.$main->rsa_ic_id.'" class="btn btn-info" target="_blank">Lite Pdf</a><br/><a href="' . base_url() . 'download_kotak_full_policy/' . $main->policy_id . '" class="btn btn-info" target="_blank">Download Pdf</a><br/>';
                    $pa_ic = "Kotak";
                    break;
                case 5:
                    $file_list = '<a href="' . base_url() . 'download_il_lite_pdf/' . $main->policy_id . '/'.$main->rsa_ic_id.'" class="btn btn-info" target="_blank">Lite Pdf</a><br/><a href="' . base_url() . 'download_icici_full_policy/' . $main->policy_id . '" class="btn btn-info" target="_blank">Download Pdf</a><br/>';
                    $pa_ic = "ICICI";
                    break;
                case 7:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    $file_list = '<a href="' . base_url() . 'download_tata_lite_pdf/' . $main->policy_id .'/'.$main->rsa_ic_id. '" class="btn btn-info" target="_blank">Lite Pdf</a><br/><a href="' . base_url() . 'download_tata_full_policy/' . $main->policy_id . '" class="btn btn-info" target="_blank">Download Pdf</a><br/>';
                    $pa_ic = "TATA";
                    break;
                case 10:
                    ...
                    $pa_ic = "Oriental";
                case 12:
                    $file_list = '<a href="' . base_url() . 'download_bagi_lite_pdf/' . $main->policy_id .'/'.$main->rsa_ic_id. '" class="btn btn-info" target="_blank">Lite Pdf</a><br/><a href="' . base_url() . 'download_bhartiaxa_full_policy/' . $main->policy_id . '" class="btn btn-info" target="_blank">Download Pdf</a><br/>';
                    $pa_ic = "Bharti Axa";
                    break;
                case 13:
